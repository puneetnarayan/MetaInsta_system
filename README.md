...
- **Colour system**: an orange accent (buttons/links/selected states) with three-level depth — base, a darker hover, and a darkest "selected/active" state — plus field-level colour coding: light orange for fields you need to fill in, light yellow for generated/heuristic fields you're free to edit, deepening to a stronger yellow while you're actively editing one (see the Help tab's "Field colours" note)
